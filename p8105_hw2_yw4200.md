...
```
    ...
    ##        id            time               ratio          current_age   
    ##  Min.   :  1.0   Length:2355        Min.   :0.09938   Min.   :56.00  
    ##  1st Qu.:122.0   Class :character   1st Qu.:0.10752   1st Qu.:63.20  
    ##  Median :242.0   Mode  :character   Median :0.10967   Median :64.90  
    ##  Mean   :242.5                      Mean   :0.10969   Mean   :65.05  
    ##  3rd Qu.:363.0                      3rd Qu.:0.11188   3rd Qu.:67.00  
    ##  Max.   :483.0                      Max.   :0.11871   Max.   :72.90  
    ##                                     NA's   :167                      
    ##      sex              education        apoe4            age_at_onset  
    ##  Length:2355        Min.   :12.00   Length:2355        Min.   :61.20  
    ##  Class :character   1st Qu.:16.00   Class :character   1st Qu.:68.40  
    ##  Mode  :character   Median :16.00   Mode  :character   Median :70.35  
    ##                     Mean   :16.38                      Mean   :70.51  
    ##                     3rd Qu.:18.00                      3rd Qu.:73.60  
    ##                     Max.   :20.00                      Max.   :77.20  
    ##                                                        NA's   :1905
